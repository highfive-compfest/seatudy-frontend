                ...
                materials?.map((materi, idx)=>{
                    ...
                    return(
                        <div className="relative">
                            <Link href={`${pathname}/${materi.id}`} className="hover:bg-gray-200 border-2 border-gray-200 px-4 py-3 rounded-lg flex gap-2 items-center" key={idx}>
                            ...
                            <ActionButton materiId={materi.id}/>
                        </div>
                    )
                })
            }</div>
